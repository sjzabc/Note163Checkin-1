    ...
    class Program
    {
        ...
        static async Task Main()
        {
            ...
            for (int i = 0; i < _conf.Users.Length; i++)
            {
                ...
                //登录账号
                var rspMsg = await client.PostAsync("https://note.youdao.com/login/acc/login?app=web&product=YNOTE&tp=urstoken&cf=6&fr=1&systemName=&deviceType=&ru=https%3A%2F%2Fnote.youdao.com%2FsignIn%2F%2FloginCallback.html&er=https%3A%2F%2Fnote.youdao.com%2FsignIn%2F%2FloginCallback.html&validate=CN31_OiuikqM5x6yhvsMMEGKRN1k.gyVoBctYyjG81k.G6R9Cq.wwpu_RsZT9TdtT1WqAKC7qKKBz.8R4bW_CWzPZuBAux2-b96ohdZx8jWrXqHp5bxeKLnafUyv-qZf-8dqUanrcokWgVBcdcC-oOTOjGVqW-DApmxu06WSJK8VNo1tOd1PGslYiB10Gs50podaa8zcEydHsb_rjrZqfMBvq.HqpDqoI0EtJoyXIP4FGPKxr2MjtIE8annAPLv50JXP-xBs0qPGh0J5DohfEWgOivatjKB2OhKBhU9FUDBQKjPpH914VytVx87qlDcKrLhC5AWO4-XUZinE0VR7eVSxGSmehMDLWuCh0ZOAmfXi6qZsjy9k8tcneEM0kCfJ586VJ5SQjZ9d0q_0tJQ9kmDxYF1Y1YfK1GXwkkeM48xpIGx.zD_O775jnVeDiPEuHPcwAZ2VV9SVJDdcEo2TPgujsV1qK802gdb9ksReBYl9HKSAkTFVaVSYrATpsk8X3&systemName=Windows&deviceType=WindowsPC", new StringContent($"username={user.Username}&password={MD5Hash(user.Password)}", Encoding.UTF8, "application/x-www-form-urlencoded"));
